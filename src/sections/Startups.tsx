...
const startups = [
    ...
    { name: 'Velora HR', description: 'AI Talent Management Platform', website: 'https://www.velorahr.com/', phase: 'active', logo: 'https://startups-marqueza.s3.eu-central-1.amazonaws.com/velora.svg' },
